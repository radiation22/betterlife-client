...
const Login = () => {
  ...
  return (
    <div
      // style={{
      //   backgroundImage: "linear-gradient(#63B547, #17ACA7)",
      // }}
      className="bg-white py-10"
    >
      <div className="flex justify-center w-[85%] mx-auto  items-center border py-10 rounded-xl">
        <div className="flex w-full flex-col py-10 px-8 shadow  rounded-[25px] sm:p-10  text-gray-900">
            ...
            >
              <div className="relative">
                <input
                  ...
                  className="  w-full pl-10 py-3 drop-shadow-xl border-2 rounded-full border-[#66B845] focus:outline-green-500 "
              ...
              <div>
                <button
                  type="submit"
                  className="bg-gradient-to-r from-[#1793CE] to-[#1793CE] w-full px-8 py-3 font-semibold drop-shadow-xl rounded-full bg-[#9DDE2A] hover:text-white text-gray-100"
                >
                  Sign In
                </button>
              </div>
              ...
              <div className="bg-white w-[400px] p-6 rounded-lg">
                ...
                <form onSubmit={handleForgotPassword}>
                  ...
                  <div className="flex justify-end">
                    ...
                    <button
                      type="submit"
                      className="ml-2 px-4 py-2 bg-green-500 text-black rounded-md hover:bg-green-600"
                    >
                      Reset Password
                    </button>
                  </div>
          ...
          <p className="px-6 text-center text-black">
