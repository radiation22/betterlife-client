...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center w-[85%] mx-auto py-10 border rounded-xl items-center">
        <div className="flex w-full flex-col py-10 px-8 shadow   rounded-[25px] sm:p-10  text-gray-900">
          {/* Loading indicator */}
            ...
            >
              <div>
                <input
                  ...
                  className="w-full pl-10 py-3 drop-shadow-xl border rounded-full border-[#66B845] focus:outline-green-500 "
                />
              </div>
              ...
              <div>
                <input
                  ...
                  className="w-full  px-3 py-3 drop-shadow-xl  border-2 file:bg-[#160209] file:rounded-full file:border-0 file:text-white file:px-2 rounded-full  border-[#66B845] focus:outline-green-500  text-gray-400"
                />
              </div>
              <div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full border px-8 py-3 font-semibold drop-shadow-xl rounded-full bg-gradient-to-r from-[#1793CE] to-[#1793CE] hover:text-white text-gray-100"
                >
                  Sign Up
                </button>
              </div>
